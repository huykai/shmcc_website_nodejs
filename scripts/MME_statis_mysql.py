...
if(ifnull(
sum(SUCC_GPRS_ATTACH+FAIL_GPRS_ATTACH_GEN+SUCC_COMBINED_ATTACH+FAIL_COMB_ATTACH_GEN-FAIL_GPRS_ATTACH_DUE_MS_ERR-FAIL_GPRS_ATTACH_COLLISIONS)
,0),round(
(sum(SUCC_GPRS_ATTACH+SUCC_COMBINED_ATTACH)/(sum(SUCC_GPRS_ATTACH+FAIL_GPRS_ATTACH_GEN+SUCC_COMBINED_ATTACH+FAIL_COMB_ATTACH_GEN-FAIL_GPRS_ATTACH_DUE_MS_ERR-FAIL_GPRS_ATTACH_COLLISIONS))),4
)*100
,0) attachratio,
if(ifnull(
sum(SUCC_GPRS_ATTACH+FAIL_GPRS_ATTACH_GEN+SUCC_COMBINED_ATTACH+FAIL_COMB_ATTACH_GEN-FAIL_GPRS_ATTACH_DUE_MS_ERR-FAIL_GPRS_ATTACH_COLLISIONS-FAIL_GPRS_ATTACH_SIM_NOT_PROV-FAIL_GPRS_ATTACH_ILLEGAL_MS-FAIL_GPRS_ATTACH_ILLEGAL_ME-FAIL_GPRS_ATTACH_SER_NONSER_NA)
,0),round(
(sum(SUCC_GPRS_ATTACH+SUCC_COMBINED_ATTACH)/(sum(SUCC_GPRS_ATTACH+FAIL_GPRS_ATTACH_GEN+SUCC_COMBINED_ATTACH+FAIL_COMB_ATTACH_GEN-FAIL_GPRS_ATTACH_DUE_MS_ERR-FAIL_GPRS_ATTACH_COLLISIONS-FAIL_GPRS_ATTACH_SIM_NOT_PROV-FAIL_GPRS_ATTACH_ILLEGAL_MS-FAIL_GPRS_ATTACH_ILLEGAL_ME-FAIL_GPRS_ATTACH_SER_NONSER_NA))),4
)*100,0) nonusersuccratio
